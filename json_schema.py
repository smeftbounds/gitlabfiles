            ...
            "results": {
                ...
                "items": {
                    ...
                    "properties": {
                        "lumi": { "type": "number" },
                        "cme": { "type": "number" },
                        "wxcf_eft": { "type": "string" },
                        "wxcf_basis": { "type": "string" },
                        "p_order": { "type": "string" },
                    ...
                    "required": [ "lumi", "cme", "wxcf_eft", "wxcf_basis", "p_order", "eft_order", "lambda_norm", "fit_type", "ewk_inputs", "bounds_cl", "bounds_coeffs" ],
                    },
                },
            },
